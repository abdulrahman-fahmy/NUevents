<?php
   /*
   Plugin Name: NUevents
   Plugin URI: https://github.com/likenother
   description: >-
  a plugin to create a custom post [events] 
   Version: 1.0
   Author: Mr. Abdulrahman fahmy
   Author URI: https://github.com/likenother
   License: GPL2
   */
...
function uep_render_event_info_metabox( $post ) {
	...
	<p> 
		...
		<input type="text" id="uep-event-start-date" name="uep-event-start-date" class="widefat uep-event-date-input" value="<?php echo date( 'F d, Y', $event_start_date ); ?>" placeholder="Format: February 8, 2020">
	</p>
	<p>
		<label for="uep-event-end-date"><?php _e( 'Event End Date:', 'uep' ); ?></label>
		<input type="text" id="uep-event-end-date" name="uep-event-end-date" class="widefat uep-event-date-input" value="<?php echo date( 'F d, Y', $event_end_date ); ?>" placeholder="Format: February 8, 2020">
	</p>
	<?php
}
 ...
 */
include( 'inc/widget-NUevents.php' );
