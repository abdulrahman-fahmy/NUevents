 ...
 * Class NUevents
 */
class NUevents extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$NUevents = new WP_Query( $query_args );
		...
		<ul class="uep_event_entries">
			<?php while( $NUevents->have_posts() ): $NUevents->the_post();
			...
			?>
				<li class="uep_event_entry">
					<h4><a href="<?php the_permalink(); ?>" class="uep_event_title"><?php the_title(); ?></a></h4>
					<?php the_excerpt(); ?>
